...
CREATE TABLE Users (
    ...
    RoleCode      CHAR(3) NOT NULL,  -- Mã role viết tắt
    SchoolId      INT NULL,
    IsActive      BIT NOT NULL DEFAULT 1,
    CreatedAt     DATETIME2 NOT NULL DEFAULT SYSDATETIME(),
    CreatedBy     INT NULL,
...
CREATE TABLE Teachers (
    TeacherId    INT PRIMARY KEY,           -- 1‑1 với Users
...
CREATE TABLE Students (
    ...
    SchoolId    INT NOT NULL,
	ParentId     INT NULL,  
	RelationName NVARCHAR(50) NULL,  -- bm, ông bà, anh/chị, ...
...
CREATE TABLE StagingStudents (
  ...
  ParentEmail1 NVARCHAR(255) NULL, ParentRelation1 NVARCHAR(20) NULL,
  ParentEmail2 NVARCHAR(255) NULL, ParentRelation2 NVARCHAR(20) NULL,
...
CREATE TABLE Allergens (
    ...
    AllergenMatter NVARCHAR(500) NULL,              -- mô tả/chất gây dị ứng
    AllergenInfo   NVARCHAR(300) NULL               -- link/ghi chú thêm
);

CREATE TABLE Ingredients (
    IngredientId INT IDENTITY PRIMARY KEY,
    IngredientName         NVARCHAR(100) NOT NULL,
	IngredientType         NVARCHAR(100), -- protein, rau, củ, quả,...
...
CREATE TABLE AllergeticIngredients (
	...
	ReportedAt    DATETIME2 NULL,                         -- NEW
    SeverityLevel NVARCHAR(10) NULL
        CHECK (SeverityLevel IN ('low','medium','high')), -- NEW
    Notes         NVARCHAR(500) NULL,        -- NEW
    ReactionNotes NVARCHAR(500) NULL,        -- NEW
    HandlingNotes NVARCHAR(500) NULL,        -- NEW
    DiagnosedAt   DATETIME2 NULL,            -- NEW
...
CREATE TABLE FoodItems (
	...
	FoodType        NVARCHAR(150) , --tráng miệng, món chính, khai vị,...
...
CREATE TABLE Menus (
	...
	CREATE TABLE ScheduleMeal (
		...
		SchoolId   INT NOT NULL,
		MenuId     INT NOT NULL,                 -- trỏ đến menu template
		WeekStart  DATE NOT NULL,                -- ngày đầu tuần
		WeekEnd    DATE NOT NULL,                -- ngày cuối tuần
		WeekNo     SMALLINT NOT NULL,            -- 1..53
		YearNo     SMALLINT NOT NULL,            -- ví dụ: 2025
...
CREATE TABLE DailyMeals (
    ...
    ScheduleMealId  INT NOT NULL,           -- tuần cụ thể
    MealDate        DATE NOT NULL,          -- ngày thật
    ...
    CONSTRAINT UX_DailyMeals UNIQUE (ScheduleMealId, MealDate, MealType) -- chống trùng
);
...
CREATE TABLE Feedbacks (
    ...
    CreatedAt  DATETIME2 NOT NULL DEFAULT SYSDATETIME(),
	DailyMealId INT NULL, --zNew attribute
    FOREIGN KEY (SenderId) REFERENCES Users(UserId),
	CONSTRAINT FK_Feedbacks_DailyMeal FOREIGN KEY (DailyMealId) REFERENCES DailyMeals(DailyMealId) --zNew FOREIGN KEY 
);
...
CREATE TABLE PurchasePlans (
	...
	MenuId			 INT NOT NULL, --zNew attribute
	StaffId       INT NOT NULL,  -- nhân sự phụ trách
    --FOREIGN KEY (SchoolId) REFERENCES Schools(SchoolId),
	CONSTRAINT FK_PurchasePlans_Menus FOREIGN KEY (MenuId) REFERENCES Menus(MenuId), --zNew FOREIGN KEY 
...
CREATE TABLE Invoices (
    ...
    AbsentDay   INT NOT NULL DEFAULT 0, --hoc sinh nghi
...
CREATE TABLE Attendance (
    ...
    NotifiedBy   INT NULL,                 -- Ai đã ghi nhận
    CreatedAt    DATETIME2 NOT NULL DEFAULT SYSDATETIME(),
    FOREIGN KEY (StudentId)  REFERENCES Students(StudentId),
...
CREATE TABLE PurchaseOrders (
    ...
    PlanId INT NULL,
    UserId INT NOT NULL, -- Người tạo / phụ trách đơn hàng
...
CREATE TABLE PurchaseOrderLines (
    ...
    UserId INT NOT NULL, -- Người nhập dòng này (nếu cần lưu chi tiết)
